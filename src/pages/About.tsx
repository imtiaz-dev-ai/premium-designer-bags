    ...
    <div className="min-h-screen bg-background text-foreground" style={{ fontFamily: "var(--font-sans)" }}>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-4xl px-4 py-20">
          ...
          <h2 className="mb-6 text-4xl tracking-tight text-ink" style={{ fontFamily: "var(--font-display)" }}>Built on trust, not just style.</h2>
          <div className="space-y-4 text-base leading-relaxed text-muted-foreground">
            <p>Premium Designer Bags was founded by a passionate fashion sourcer based between Italy and Dubai — two of the world's most important fashion capitals. Our mission is simple: bring you access to authentic designer pieces at honest prices, with no middlemen and no guesswork.</p>
            <p>Every item in our collection is personally sourced and verified. Before we ship anything to you, we send real photos so you can approve what you're getting. We follow up every single order until it reaches your door.</p>
            <p>We operate exclusively via WhatsApp because we believe luxury deserves a personal touch — not an anonymous checkout flow. You speak directly with us, and we handle everything from sourcing to delivery.</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-4xl px-4 py-20">
          <div className="grid grid-cols-3 gap-8 text-center">
            {[{ n: "15K+", l: "Happy Clients" }, { n: "50+", l: "Designer Brands" }, { n: "98%", l: "Satisfaction Rate" }].map((s) => (
              <div key={s.l}>
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-3xl px-4 py-20 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <Link to="/" className="inline-flex items-center gap-2 border-2 border-burgundy px-10 py-4 text-xs font-semibold uppercase tracking-[0.25em] text-burgundy transition hover:bg-burgundy hover:text-cream">
              Browse Collection
            </Link>
          </div>
