...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "luxury designer bags, authentic designer handbags, Louis Vuitton, Chanel, Hermès, Dior, Gucci, Prada, luxury fashion Italy Dubai, designer bags worldwide shipping" },
      { name: "author", content: "Premium Designer Bags" },
      { name: "robots", content: "index, follow" },
      { name: "theme-color", content: "#6b1d2e" },
      ...
      { name: "twitter:image", content: "https://premiumdesignerbags.com/og-image.jpg" },
    ],
    links: [
      {
        rel: "stylesheet",
